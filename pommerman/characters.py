...
class Bomber(object):
    ...
    def __init__(self, agent_id=None, game_type=None):
        ...
        self.ammo = 1
        self.num_bomb_placed = 0
        self.life_length = 0
        self.score = 0
        self.visited_position = np.zeros((constants.BOARD_SIZE, constants.BOARD_SIZE))
        self.is_alive = True
    ...
    def reset(self, ammo=1, is_alive=True, blast_strength=None, can_kick=False):
        ...
        self.score = 0
        self.is_random = False
        #print('[agent] life_length reset to: {}'.format(self.life_length))
        #print('[agent] num_bomb_placed reset to: {}'.format(self.num_bomb_placed))
    ...
    def destroy_wood(self):
        self.score += 30

    def new_position(self):
        r, c = self.position
        if self.visited_position[r][c] == 0:
            self.visited_position[r][c] = 1
            #self.score += 10
